...
$mesec = $_POST['mesec'];
$godina = $_POST['godina'];
$query = "SELECT * FROM slajd  WHERE mesec = $mesec AND godina = $godina";
...
function izmeni(id){
	window.location = "slider_edit.php?id="+id;
	}
function obrisi(id){
	if (confirm('Da li stvarno zelite brisanje?')){
 		 window.location = "slider_delete.php?id="+id; }
	else {
  		window.location.href = 'slider_search.php' }
}	
</script>
</head>
