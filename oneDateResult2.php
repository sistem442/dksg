  ...
  <DIV id="main">
    ...
    <div class="content-item">
      ...
      <div class="content-item-content"> 
	  	<?php echo ($row['nadnaslov']);?><br />
		<strong><?php echo ($row['imePrograma']);?></strong><br />
		<?php echo ($row['dan'].'.'.$row['mesec'].' u '.$row['time'].', '.$row['mesto']);?>
		<?php echo ($row['podnaslov']);?><br />
