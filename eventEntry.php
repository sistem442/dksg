...
9,9,2013, Dodata 4 polja, validacija
-->
...
var aaa = '<?php print_r($_GET['arhiva']); ?>';
...
$(document).ready(function(){
	...
	if(aaa == 'aaa' && grupa == '#urednici'){sakri2();}//sakriva unos arhivskog materijala kada urednik unosi stari dogadjaj
...
<input type="hidden" id="grupa" value="<?php echo($_SESSION['grupa']); ?>"/>
<input type="hidden" id="arhiva" value="<?php echo($_GET['arhiva']); ?>"/>
<form action="eventEntryResult.php"  method="post" enctype="multipart/form-data" name="eventForm" id="eventForm" >
  <div class="title">Unos teksta i fajlova za novi događaj</div>
  <div class="left">Sažeti opis</div>
  <div class="right">
    <input style="width:680px" type="text" id="s_opis" name="s_opis" />
  </div>
  ...
  <div class="clearfloat"></div>
  <div class="left"> Ključne reči</div>
  <div class="right">
    <input style="width:680px" type="text" id="k_reci" name="k_reci" />
  </div>
  <div class="clearfloat"></div>
  ...
  <div class="clearfloat"></div>
  <div class="left">Redakcija</div>
  <div class="right">
    <input type="hidden" value="0" name="prioritet" id="prioritet" />
    <select name="program" id="program"  style="width:180px">
    <option value="politicki">DRUŠTVENO POLITIČKI PROGRAM</option>
	<option value="naucni">NAUČNO OBRAZOVNI PROGRAM</option>
	<option value="kontakt">KONTAKT PROGRAM</option>
  ...
  <div class="clearfloat"></div>
  <div class="left"><span style="color:#0C0; background-color:#000; padding:5px;">Tekst i dalje mora biti kompletan!</span> <br /><br />
Sa naslovom, nadnaslovom, podnaslovom, vremenom i mestom zbog kompatibilnosti sa starijim unosima. </div>
  <div class="right">
...
Unesite početnji i poslednji datum događaja!</div>
  ...
  <div class="clearfloat"></div>
  <div class="left">Fotograf</div>
  <div class="right">
    <input style="width:680px" type="text" id="fotograf" name="fotograf" />
  </div>
  <div class="clearfloat"></div>
