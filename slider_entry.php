...
<br />";
	...
	//************************************Prikazujem koliko ima starih slajdova i nudim brisanje
		$mesec = date('n');
		$godina = date('Y');
		$query = "SELECT COUNT(*) as Num FROM slajd WHERE ((mesec < $mesec AND godina = $godina) ||  godina < $godina);";
		//echo $query;
...
if(isset($_POST['submit2'])){
	...
	$query2 = "INSERT INTO slajd (id,title,path,link,dan,mesec,godina) VALUES ( $id,'$data','$path','$link',$dan,$mesec,$godina)";
...
<div class="container2">
  <div class="blueBold">Unos slajda</div>
  <br />
