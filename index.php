  ...
  <DIV id="main">
    <?php 
		...
		$datum = $godina.$mesec.$dan;
			//dodato za novu godinu
			/*
			if(($datum == 20131231) || (($datum >= 20140101) && ($datum <=20140107)))
				echo "Dom kulture Studentski grad neće raditi za vreme Nove godine i Božićnih praznika od 31. 12. 2013. do 07. 01. 2014. godine.";
			*/	
			if((($datum >= 20140501) && ($datum <=20140504)))
			{
								echo "Dom kulture Studentski grad neće raditi za vreme Prvomajskih praznika 
								od 1. 5. 2014. do 5. 5. 2014. godine.";
					...
					while($row = mysql_fetch_array($result)){
							...
							<div class="content-item">
							  <div class='content-item-photo'> 
								<img  src='<?php if($row['slika']!= '0'){echo 'http://www.dksg.rs/'.$row['slika'];} 
													else echo "http://www.dksg.rs/images/osnovne/belo.png"?>'>
							  </div>
