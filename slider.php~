...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<!-- Skitter Styles -->
	<link href="http://www.dksg.rs/slider2/css/skitter.styles.css" type="text/css" media="all" rel="stylesheet" />

	<!-- Skitter JS -->
    <script type="text/javascript" src="http://www.dksg.rs/jquery-1.10.1.min.js"></script>
